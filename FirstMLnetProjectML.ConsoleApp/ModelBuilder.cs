...
using FirstMLnetProjectML.Model.DataModels;

namespace FirstMLnetProjectML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\csharpProject\MLnetApp\FirstMLnetProject\FirstMLnetProject\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../FirstMLnetProjectML.Model/MLModel.zip";
